...
- **macOS/Linux**: `~/.local/share/opencode-unchained/log/`
- **Windows**: `%APPDATA%\opencode-unchained\log\`
...
- **macOS/Linux**: `~/.local/share/opencode-unchained/`
- **Windows**: `%USERPROFILE%\.local\share\opencode-unchained`
